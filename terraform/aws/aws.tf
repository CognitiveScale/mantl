...
variable "control_spot_price" = { default = "0.02" }
variable "edge_spot_price" = { default = "0.04" }
variable "worker_spot_price" = { default = "0.04" }
variable "wait_for_fulfillment" = {default = true}
variable "control_spot_type" = "m3.medium"
variable "edge_spot_type" = "m3.medium"
variable "worker_spot_type" = "m3.large"
...
module "control-nodes" {
  source = "./terraform/aws/spot_instance"
  count = "${var.control_count}"
  datacenter = "${var.datacenter}"
  role = "control"
  ec2_type = "${var.control_spot_type}"
  spot_price = "${control_spot_price}"
...
module "edge-nodes" {
  ...
  datacenter = "${var.datacenter}"
  role = "edge"
  ec2_type = "${var.edge_spot_type}"
  spot_price = "${var.edge_spot_price}"
  wait_for_fulfillment = "${var.wait_for_fulfillment}"
  ssh_username = "${var.ssh_username}"
  source_ami = "${lookup(var.amis, var.region)}"
  short_name = "${var.short_name}"
...
module "route53" {
  ...
  control_eips = "${module.control-nodes.ec2_eips}"
  domain = "${var.dns_domain}"
  edge_count = "${var.edge_count}"
  edge_ips = "${module.edge-nodes.ec2_ips}"
  edge_eips = "${module.edge-nodes.ec2_eips}"
  ...
  worker_eips = "${module.worker-nodes.ec2_eips}"
}
